    ...
    <main ref={pageRef} className="site-shell" onMouseMove={moveCursor}>
      ...
      <section className="hero">
        ...
        <div className="hero-copy">
          ...
          <motion.h1 initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35, duration: 1, ease }}>COME WITH<br /><em>YOUR QUESTION.</em></motion.h1>
      ...
      <motion.section className="manifesto" id="the-room" initial={{ opacity: 0, y: 36 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease }}>
      ...
      <section className="cards-showcase">
        <motion.div className="cards-photo image-frame" initial={{ clipPath: 'inset(8% 8% 8% 8%)' }} whileInView={{ clipPath: 'inset(0% 0% 0% 0%)' }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 1.2, ease }}><img src={cardsImage} alt="Tarot cards laid out for a reading" loading="lazy" /><div className="cards-glow" /><span className="image-caption">THE DECK / LISTEN CLOSELY</span></motion.div>
